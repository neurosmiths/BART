function [bhvStruct] = BARTbehaviorRTs(ptID,plotFlag)
...
% postBankRedRTs = postBankRedRTs(~outRTs);
% postPopRedRTs = postPopRedRTs(~outRTs);
% postBankOrgRTs = postBankOrgRTs(~outRTs);
% postPopOrgRTs = postPopOrgRTs(~outRTs);
% postBankYelRTs = postBankYelRTs(~outRTs);
% postPopYelRTs = postPopYelRTs(~outRTs);
